...
var get_data = function(uri) {
  ...
  $.ajax({
    ...
    method: 'GET',
      ...
      // encompassing hash
      var results = {'cv': [], 'booksLabel': [], 'name': [], 'primaryPositionLabel': [], 'primaryPosition': [], 'secondaryPositionLabel': [], 
                     ...
                     'academicArticlesLabel': [], 'academicArticles': [], 'books': [], 'bookReviews': [], 'bookSections': [], 'bookSeries': [], 
